        ...
        <div className={`p-5 pb-24 ${isActive ? 'block' : 'hidden'} animate-slide-up`}>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-border">
                ...
                <div className="flex flex-col gap-2 mb-6">
                    ...
                    <SwipeableRow label="렌트" value={costs.rent} onChange={(v) => handleCostChange('rent', v)} checked={status.rent} onCheck={(c) => handleStatusChange('rent', c)} disabled={!unlocked} onDelete={() => handleCostChange('rent', '0')} />
                    <SwipeableRow label="주유비" value={costs.gas} onChange={(v) => handleCostChange('gas', v)} checked={status.gas} onCheck={(c) => handleStatusChange('gas', c)} disabled={!unlocked} onDelete={() => handleCostChange('gas', '0')} />
